...
print(f"Pointer val 1 {pointer_value2:.2f}")
print(f"Pointer val 1 {pointer_value3:.2f}")
print()
print(f"Pointer val 1 {pointer_value1}")
print(f"Pointer val 1 {pointer_value2}")
print(f"Pointer val 1 {pointer_value3}")
print()
print(f"Pointer val 1 {pointer_value1:10}")
print(f"Pointer val 1 {pointer_value2:10}")
print(f"Pointer val 1 {pointer_value3:10}")
print()
print(f"Pointer val 1 {pointer_value1:010}")
print(f"Pointer val 1 {pointer_value2:010}")
print(f"Pointer val 1 {pointer_value3:010}")
print()
print(f"Pointer val 1 {pointer_value1:<10}")
print(f"Pointer val 1 {pointer_value2:<10}")
print(f"Pointer val 1 {pointer_value3:<10}")
