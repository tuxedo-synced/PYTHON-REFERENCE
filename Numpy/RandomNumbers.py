...
fruits_1 = np.array(["apple","banana","custard apple","mango"])
fruits_2 = np.array(["apple","banana","custard apple","mango"])
fruits_1= rng.choice(fruits_1,size=(3,3))
fruits_2 = rng2.choice(fruits_2,size=(3,3))
print(fruits_1)
print(fruits_2)
